...
values("有島武朗","1878-1923年","明治11年、東京生まれ。札幌農学校卒業後、3年間アメリカに留学。帰国後、母校の予科教授となる。43年、創刊された雑誌『白樺』の同人となり、文学活動をはじめる。代表作に『カインの末裔』、『或る女』、『惜しみなく愛は奪ふ』などがある。"),
		...
		("梶井基次郎","1901-1932年","大阪生まれ。少年時代は三重、東京などに転居を繰り返す。19年、エンジニアを目指して三高理科に入学するが次第に文学に惹かれ、24年、東京帝大英文科に入学。同人誌『青空』で積極的に活動するが、少年時代からの肺結核が悪化し卒業は叶わなかった。初めての創作集『檸檬』刊行の翌年、郷里大阪にて逝去。享年31歳。"),
